...
if(NOT DEFINED CMAKE_INSTALL_LIBDIR OR (_libdir_set
  ...
  if(CMAKE_SYSTEM_NAME MATCHES "^(Linux|kFreeBSD|GNU)$"
    ...
    if (EXISTS "/etc/debian_version") # is this a debian system ?
      file(STRINGS "/etc/debian_version" DEBIAN_VERSION)
      # Multiarch support in only supported by pkg-config on Debian 7.
      if(CMAKE_LIBRARY_ARCHITECTURE AND DEBIAN_VERSION VERSION_GREATER "7.0")
